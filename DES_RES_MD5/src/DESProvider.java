...
public class DESProvider {  
    ...
    public static byte[] encrypt(String data,String key) throws Exception{  
    	byte[] bytes = data.getBytes();//将数据转换成字节数组
    ...
    public static void main(String[] args) throws Exception{
    	...
    	byte[] ctext1=DESProvider.decrypt(ctext, symmetricKey);   //解密
    	System.out.println("加密"+new String(ctext));
    	System.out.println("解密"+new String(ctext1));
